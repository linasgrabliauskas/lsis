...
function Informal() {
  ...
  // Endpoints
  const endPoint = `https://lsis.herokuapp.com/api/informal/page/${page}`
  ...
  return (
    <main>
      ...
      <div className='informal-list-wrapper'>
        <h2 className='heading-2'> NEFORMALUS UGDYMAS </h2>
      </div>

      <div className='table-wrapper'>
        <SearchControll url={endPointInformalFilter} handleSetData={handleSetData} setPagesSeeing={setPagesSeeing}/>
        {loaded ? <Table data={data} informal={true}/> : <Spinner/>}
